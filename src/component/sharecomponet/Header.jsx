...
const Header = () => {
    ...
    const menu = <>
        ...
        <li><NavLink to='/to' className={({ isActive }) => (isActive ? 'bg-blue-700 hover:bg-purple-800 text-white text-xl font-bold' : 'text-xl font-bold')}>About</NavLink> </li>
        ...
        <div className="navbar bg-base-100 shadow-lg">
            ...
            <div>
                <label className="cursor-pointer grid place-items-center">
                    <input onChange={handleTheam} type="checkbox" value="synthwave" className="toggle theme-controller bg-base-content row-start-1 col-start-1 col-span-2" />
